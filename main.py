...
class TodoListApp(tk.Tk):
    def __init__(self):
        ...
        style.configure("Custom.TEntry", foreground="white")
        ...
        # Bind events to clear/restore placeholder
        ...
        self.task_list = tk.Listbox(
            ...
            font=("TkDefaultFont", 16),
            height=10,
            selectmode=tk.SINGLE  # Set selectmode to SINGLE
        )
    ...
    def add_task(self):
        ...
        if task != "Enter your todo here...":
            ...
            self.task_list.itemconfig(tk.END, fg="Dark white")
    ...
    def mark_done(self):
        ...
        if task_index:
            # Corrected the way to retrieve the selected item index
            selected_index = task_index[0]
